...
CREATE TABLE `adocao` (
  ...
  CONSTRAINT `adocao_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`),
  CONSTRAINT `adocao_ibfk_2` FOREIGN KEY (`animal_id`) REFERENCES `animal` (`id`)
...
INSERT INTO `adocao` VALUES (1,55,2,'2024-11-28 23:51:31');
...
-- Dump completed on 2024-11-29  4:26:34
